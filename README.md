...
4. select contact with id
     ...
     - change name -> If the input is not valid, it will ask for input again
     - change surname -> If the input is not valid, it will ask for input again
     - change number -> If the input is not valid, it will ask for input again
     - change email -> If the input is not valid, it will ask for input again
     - delete -> will remove the contact and return to the main menu.
